...
const SettingsScreen = ({
    ...
    const renderAIStatus = () => {
        switch (aiStatus) {
            ...
            case 'demo':
                return (
                    <div className="flex items-center justify-center p-2 rounded-lg bg-yellow-100 dark:bg-yellow-900/30">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-600 dark:text-yellow-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                        <span className="text-sm font-semibold text-yellow-800 dark:text-yellow-300">AI Service: Demo Mode</span>
                    </div>
                );
            case 'unavailable':
                 return (
